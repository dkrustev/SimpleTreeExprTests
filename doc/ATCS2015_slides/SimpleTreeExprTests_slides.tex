...
\begin{frame}[Unlabeled Binary Trees]
  ...
  \begin{itemize}
    ...
    \begin{itemize}
	  \item $\lceil \bullet \rceil_{\text{Bool}} ~:~ \text{Bool} \rightarrow \text{T}$
	  \[
	    \begin{array}{cc}
	  ...
	  \item $\lceil \bullet \rceil_{\mathbb{N}} ~:~ \mathbb{N} \rightarrow \text{T}$
	  \[
	    \begin{array}{cc}
	  ...
	  \item $\lceil \bullet \rceil_{\text{List}(X)} ~:~ \text{List}(X) \rightarrow \text{T}$
	  \[
	    \begin{array}{lcl}
...
\begin{frame}
  ...
  \[
    \begin{array}{lcl}
    \llbracket \bullet \rrbracket & : & E \rightarrow \text{T} \rightarrow \text{T}_{\perp} \\
